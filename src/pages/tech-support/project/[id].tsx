...
import TechSupportProjectDetail from "@domains/project/components/tech-support-project-detail";
...
const TechSupportDetailPage: NextPage = () => {
    ...
    const { data: projectData } = useQuery(
        [router.isReady, `get tech-support project detail of project ${id}`],
        ...
        useMutation(
                ...
                }),
            {
                onSuccess(data, variables, context) {
                    router.push(PATH.TECHSUPPORT.PROJECT.MAIN);
                },
            }
        );
                    ...
                    {!projectData?.project_by_pk.deleted_at && (
                        <div className="btn-group">
                            ...
                            <IconButton
                                ...
                                onClick={() =>
                                    router.push(
                                        `${PATH.TECHSUPPORT.PROJECT.EDIT}/${id}`
                                    )
                                }
                                disabled={
                                    projectData?.project_by_pk.is_canceled
...
export default TechSupportDetailPage;
