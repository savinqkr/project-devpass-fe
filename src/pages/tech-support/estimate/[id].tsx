...
import { TechSupportEstimateDetail } from "@domains/estimate/components";
import { IconButton } from "@mui/material";
import { MdOutlineDelete, MdOutlineEdit } from "react-icons/md";

const TechSupportEstimateDetailPage: NextPage = () => {
    ...
    const { data: deletedEstiamte, mutate: deleteEstimateMutate } = useMutation(
        ...
        {
            onSuccess(data, variables, context) {
                router.push(PATH.TECHSUPPORT.ESTIMATE.MAIN);
            },
        }
    );
                            ...
                            !estimateData?.estimate_by_pk.is_final && (
                                <>
                                    ...
                                    <IconButton
                                        ...
                                        onClick={() =>
                                            router.push(
                                                `${PATH.TECHSUPPORT.ESTIMATE.EDIT}/${id}`
                                            )
                                        }
                                        disabled={
                                            estimateData?.estimate_by_pk.project
...
export default TechSupportEstimateDetailPage;
