...
const TechSupportEstimateRegister: NextPage = () => {
    ...
    const { data: registeredData, mutate: registerEstiamteMutate } =
        useMutation(
            ["register new tech support estimate"],
            () =>
                ...
                }),
            {
                onSuccess(data, variables, context) {
                    router.push(
                        `${PATH.TECHSUPPORT.ESTIMATE.MAIN}/${data.registerEstimate.estimate.id}`
                    );
                },
            }
        );
    ...
    return (
        <BasicTemplate>
            <PageTitle title="기술지원 견적 등록" isVisible={false} />
...
export default TechSupportEstimateRegister;
