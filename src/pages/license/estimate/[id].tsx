...
import { LicenseEstimateDetail } from "@domains/estimate/components";
import { IconButton } from "@mui/material";
import { MdOutlineEdit } from "react-icons/md";
import { MdOutlineDelete } from "react-icons/md";

const LicenseEstimateDetailPage: NextPage = () => {
    ...
    const { data: deletedEstiamte, mutate: deleteEstimateMutate } = useMutation(
        ...
        {
            onSuccess(data, variables, context) {
                router.push(PATH.LICENSE.ESTIMATE.MAIN);
            },
        }
    );
...
export default LicenseEstimateDetailPage;
