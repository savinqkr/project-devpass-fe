...
const RepairEstimateRegister: NextPage = () => {
        ...
        useMutation(
                ...
                }),
            {
                onSuccess(data, variables, context) {
                    ...
                    router.push(
                        `${PATH.REPAIR.ESTIMATE.MAIN}/${data.registerEstimate.estimate.id}`
                    );
                },
            }
        );
    ...
    return (
        <BasicTemplate>
            <PageTitle title="유지보수 견적 등록" isVisible={false} />
            <RepairEstimateForm
                register={register}
                control={control}
                errors={errors}
...
export default RepairEstimateRegister;
