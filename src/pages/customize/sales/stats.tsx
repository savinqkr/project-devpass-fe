...
const CustomizeSalesStats: NextPage = () => {
    // 현재 년도
    ...
    const { data: commonType } = useQuery(["getCommonCode"], () =>
        codeService.getCommonCode({
            where: {
                ...
                value: { _eq: ProductType.CUSTOMIZE },
            },
        })
    );
    ...
    const {
        ...
        () =>
            salesService.getAllSales({
                where: {
                    common_type: { value: { _in: [ProductType.CUSTOMIZE] } },
                    // project: {
    ...
    const {
        ...
        () =>
            contractService.getAllContract({
                where: {
                    type: { value: { _in: [ProductType.CUSTOMIZE] } },
                    // project: {
                    //     is_canceled: { _eq: false },
                    // },
                    deleted_at: { _is_null: true },
            ...
            <BasicTemplate>
                ...
                <div id="contents-section">
                    <div id="sales-status-chart-section" className="section">
                        ...
                        <SalesStatusChart
                            common_type={ProductType.CUSTOMIZE}
                            salesData={salesData}
...
export default CustomizeSalesStats;
