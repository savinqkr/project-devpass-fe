...
const CustomizeEstimateRegister: NextPage = () => {
        ...
        useMutation(
                ...
                }),
            {
                onSuccess(data, variables, context) {
                    router.push(
                        `${PATH.CUSTOMIZE.ESTIMATE.MAIN}/${data.registerEstimate.estimate.id}`
                    );
                },
            }
        );
    ...
    return (
        <BasicTemplate>
            <PageTitle title="커스터마이징 개발 견적 등록" isVisible={false} />
...
export default CustomizeEstimateRegister;
