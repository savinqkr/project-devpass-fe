...
import CommentsContent from "@domains/comments/components/comments-content";
import PATH from "@constants/path";
import { IoAddOutline } from "react-icons/io5";
import { useRouter } from "next/router";
import calculatePeriod from "@utils/calculatePeriod";

const VRepairProjectDetail: React.FC<IRepairProjectDetail.IVProps> = props => {
        ...
        <div css={rootStyle(isMedium)}>
            ...
            <div className="group">
                ...
                <div className="contents">
                    ...
                    <MuiDataGrid
                        ...
                        rowLimit={5}
                        onClickRow={onClickLicenseContractRow}
                        msg="등록된 라이선스 도입 사업 목록이 없습니다."
                    />
                </div>
            </div>
            <div className="group">
            ...
            <div className="group">
                ...
                <div className="contents">
                    <div className="row-section">
                        <DetailInfoRow
                            label="엔지니어"
                            value={projectData?.project_by_pk.consultant_name}
                        />
                        <DetailInfoRow
                            label="이메일"
                            value={projectData?.project_by_pk.consultant_email}
                        />
                    </div>
                    <div className="row-section">
                        <DetailInfoRow
                            label="연락처"
                            value={
                                projectData?.project_by_pk.consultant_contact
                            }
                        />
                        <DetailInfoRow
                            label="핸드폰번호"
                            value={projectData?.project_by_pk.consultant_phone}
                        />
                    </div>
                    <Divider className="divider" />
                </div>
            ...
            <div className="group">
                ...
                <div className="contents">
                    <DetailInfoRow
                        label="점검 주기"
                        value={projectData?.project_by_pk.inspect_cycle}
                    />
                    <DetailInfoRow
                        label="점검 방법"
                        value={projectData?.project_by_pk.inspect_method}
                    />
                    <DetailInfoRow
                        label="점검 옵션"
                        value={projectData?.project_by_pk.inspect_option}
                    />
                    <DetailInfoRow
                        isNote={true}
                        label="비고"
                        value={projectData?.project_by_pk.inspect_note}
                    />
                    <Divider className="divider" />
                </div>
            </div>
            <div className="group">
                ...
                <div className="contents">
                    <DetailInfoRow
                        label="유지보수 요율"
                        value={
                            typeof projectData?.project_by_pk.repair_rate ===
                            "number"
                                ? `${projectData?.project_by_pk.repair_rate} %`
                                : "-"
                        }
                    />
                    <DetailInfoRow
                        label="전년 요율"
                        value={
                            typeof projectData?.project_by_pk
                                .repair_last_year_rate === "number"
                                ? `${projectData?.project_by_pk.repair_last_year_rate} %`
                                : "-"
                        }
                    />
                    <Divider className="divider" />
...
export default VRepairProjectDetail;
