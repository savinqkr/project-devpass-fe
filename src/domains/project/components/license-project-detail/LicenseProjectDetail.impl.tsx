...
import VLicenseProjectDetail from "./LicenseProjectDetail.view";
...
const LicenseProjectDetail: React.FC<ILicenseProjectDetail.IProps> = props => {
    ...
    const onClickPartnerRow = (pk: string) => {
        setChatScreenRecoil(false); // 댓글창 닫음
        router.push(`${PATH.CLIENT.COMPANY.MAIN}/${pk}`);
    };
    ...
    const partnerColumns: GridColDef[] = [
        ...
        { field: "name", headerName: "SI / 파트너사", flex: 3 },
    ];
    ...
    return (
        <VLicenseProjectDetail
            ...
            onClickPartnerRow={onClickPartnerRow}
...
export default LicenseProjectDetail;
