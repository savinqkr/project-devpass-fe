...
import { ILicenseProjectDetail } from "./LicenseProjectDetail.interface";
import {
    Button,
    Chip,
    Divider,
...
const VLicenseProjectDetail: React.FC<
    ILicenseProjectDetail.IVProps
> = props => {
        ...
        <div css={rootStyle(isMedium)}>
                ...
                <div className="contents">
                    ...
                    <div className="row-section">
                        <DetailInfoRow
                            label="계약사"
                            value={
                                projectData?.project_by_pk?.contractor?.name ||
                                "-"
                            }
                        />
                        <DetailInfoRow
                            label="사업자등록번호"
                            value={
                                projectData?.project_by_pk?.contractor
                                    ?.busi_no || "-"
                            }
                        />
                    </div>
                    <div className="row-section">
                        ...
                        <DetailInfoRow
                            label="운영전환일"
                            value={
                                !!projectData?.project_by_pk.optrans_date
                                    ? dayjs(
                                          projectData?.project_by_pk
                                              .optrans_date
                                      ).format("YYYY년 MM월 DD일")
                    ...
                    <div className="row-section">
                        <DetailInfoRow
                            label="검수일"
                            value={
                                projectData?.project_by_pk.inspect_date
                                    ? dayjs(
                                          projectData?.project_by_pk
                                              .inspect_date
                                      ).format("YYYY년 MM월 DD일")
                        ...
                        <DetailInfoRow
                            label="무상기간"
                            value={`${
                                projectData?.project_by_pk.free_start_date
                                    ? dayjs(
                                          projectData?.project_by_pk
                                              .free_start_date
                                      ).format("YYYY년 MM월 DD일")
                                ...
                                projectData?.project_by_pk.free_end_date
                                    ? dayjs(
                                          projectData?.project_by_pk
                                              .free_end_date
                                      ).format("YYYY년 MM월 DD일")
                    ...
                    <DetailInfoRow
                        label="사업 참여 형태"
                        value={projectData?.project_by_pk.participate_type}
                    />
            ...
            <div className="group">
                ...
                <div className="contents">
                    <DetailInfoRow
                        label="비고"
                        value={projectData?.project_by_pk.note}
                        isNote={true}
                    />
                    <Divider className="divider" />
                </div>
                            ...
                            <>
                                <div className="tab-tool">
                                    <IconButton
                                        ...
                                        onClick={() =>
                                            router.push(
                                                PATH.LICENSE.ESTIMATE.REGISTER
                                            )
                                        }
                                    >
                                        <IoAddOutline />
                            ...
                            <>
                                <div className="tab-tool">
                                    <IconButton
                                        ...
                                        onClick={() =>
                                            router.push(
                                                PATH.LICENSE.CONTRACT.REGISTER
                                            )
                                        }
                                    >
                                        <IoAddOutline />
...
export default VLicenseProjectDetail;
