...
import VCustomizeProjectDetail from "./CustomizeProjectDetail.view";
...
const CustomizeProjectDetail: React.FC<
    ICustomizeProjectDetail.IProps
> = props => {
    ...
    const { data: canceledProjectData, mutate: cancelPrijectByPkMutate } =
        useMutation([`cancel customize dev project of ID : ${id}`], () =>
...
export default CustomizeProjectDetail;
