...
const VTechSupportProjectDetail: React.FC<
    ITechSupportProjectDetail.IVProps
> = props => {
                            ...
                            <>
                                <div className="tab-tool">
                                    <IconButton
                                        ...
                                        onClick={() =>
                                            router.push(
                                                PATH.TECHSUPPORT.SALES.REGISTER
                                            )
                                        }
                                    >
                                        <IoAddOutline />
...
export default VTechSupportProjectDetail;
