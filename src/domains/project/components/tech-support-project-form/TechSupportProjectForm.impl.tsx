...
import { ITechSupportProjectForm } from "./TechSupportProjectForm.interface";
import VTechSupportProjectForm from "./TechSupportProjectForm.view";

const TechSupportProjectForm: React.FC<
    ITechSupportProjectForm.IProps
> = props => {
...
export default TechSupportProjectForm;
