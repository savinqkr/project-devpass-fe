...
const VTechSupportProjectForm: React.FC<
    ITechSupportProjectForm.IVProps
> = props => {
            ...
            <form autoComplete="off" onSubmit={onClickSubmit}>
                ...
                <div className="btn-section">
                    ...
                    <Button
                        ...
                        type="submit"
                    >
                        {router.pathname === PATH.TECHSUPPORT.PROJECT.REGISTER
                            ? "등록"
                            : "수정"}
                    </Button>
                </div>
...
export default VTechSupportProjectForm;
