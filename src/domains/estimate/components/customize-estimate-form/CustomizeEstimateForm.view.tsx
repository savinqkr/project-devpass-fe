...
const VCustomizeEstimateForm: React.FC<
    ICustomizeEstimateForm.IVProps
> = props => {
            ...
            <form autoComplete="off" onSubmit={onClickSubmit}>
                ...
                <div className="btn-section">
                    ...
                    <Button
                        ...
                        type="submit"
                    >
                        {router.pathname === PATH.CUSTOMIZE.ESTIMATE.REGISTER
                            ? "등록"
                            : "수정"}
                    </Button>
                </div>
...
export default VCustomizeEstimateForm;
