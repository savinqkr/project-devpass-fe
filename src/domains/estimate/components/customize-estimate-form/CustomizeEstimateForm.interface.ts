...
export namespace ICustomizeEstimateForm {
    export interface IProps {
        register: UseFormRegister<ICustomizeEstimateForm.IForm>;
        control: Control<ICustomizeEstimateForm.IForm, any>;
        errors: FieldErrors<ICustomizeEstimateForm.IForm>;
        watch: UseFormWatch<ICustomizeEstimateForm.IForm>;
        getValues: UseFormGetValues<ICustomizeEstimateForm.IForm>;
        setValue: UseFormSetValue<ICustomizeEstimateForm.IForm>;
        onClickSubmit: () => void;
        rows: GridRowsProp;
