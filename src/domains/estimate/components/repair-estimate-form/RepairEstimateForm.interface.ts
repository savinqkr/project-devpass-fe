...
export namespace IRepairEstimateForm {
    export interface IProps {
        register: UseFormRegister<IRepairEstimateForm.IForm>;
        control: Control<IRepairEstimateForm.IForm, any>;
        errors: FieldErrors<IRepairEstimateForm.IForm>;
        watch: UseFormWatch<IRepairEstimateForm.IForm>;
        getValues: UseFormGetValues<IRepairEstimateForm.IForm>;
        setValue: UseFormSetValue<IRepairEstimateForm.IForm>;
        onClickSubmit: () => void;
        rows: GridRowsProp;
    ...
    export interface IVProps extends IProps {
        ...
        onClickOpenRepairEstimateDetailModal: () => void;
    }
    ...
    export interface IDetailForm {
        ...
        monthly_repair_price?: number; // 월유지보수금액 = 공급금액에 유지보수 요율 적용한 값 ( 유지보수 요율 = null 이면 15% 적용 )
        total_repair_price?: number; // 총유지보수금액 = 월유지보수금액 * ( 계약 종료일 - 계약 시작일 ) 개월
