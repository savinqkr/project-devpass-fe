...
const VRepairEstimateForm: React.FC<IRepairEstimateForm.IVProps> = props => {
            ...
            <form autoComplete="off" onSubmit={onClickSubmit}>
                ...
                <div className="group">
                    <div className="title-section">
                        ...
                        <Button
                            variant="outlined"
                            color="gray"
                            sx={{ width: 200, fontSize: 12, height: 32 }}
                            onClick={onClickOpenRepairEstimateDetailModal}
                        >
                            라이선스 도입 사업 추가
                        </Button>
                    </div>
                ...
                <div className="btn-section">
                    ...
                    <Button
                        ...
                        type="submit"
                    >
                        {router.pathname === PATH.REPAIR.ESTIMATE.REGISTER
                            ? "등록"
                            : "수정"}
                    </Button>
                </div>
...
export default VRepairEstimateForm;

const rootStyle = (isMedium: boolean, vatChecked: boolean) => {
    return css`
        .header-btn {
            margin-top: 12px;
            display: flex;
