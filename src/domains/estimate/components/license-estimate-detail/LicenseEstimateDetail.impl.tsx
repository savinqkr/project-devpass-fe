...
import { ILicenseEstimateDetail } from "./LicenseEstimateDetail.interface";
import VLicenseEstimateDetail from "./LicenseEstimateDetail.view";
import { GridColDef } from "@mui/x-data-grid";
import moneyToNumber from "@utils/moneyToNumber";
import numberToMoney from "@utils/numberToMoney";
import { TextareaCell } from "@common/components";

const LicenseEstimateDetail: React.FC<
    ILicenseEstimateDetail.IProps
> = props => {
...
export default LicenseEstimateDetail;
