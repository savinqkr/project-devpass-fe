...
export namespace ITechSupportEstimateForm {
    export interface IProps {
        register: UseFormRegister<ITechSupportEstimateForm.IForm>;
        control: Control<ITechSupportEstimateForm.IForm, any>;
        errors: FieldErrors<ITechSupportEstimateForm.IForm>;
        watch: UseFormWatch<ITechSupportEstimateForm.IForm>;
        getValues: UseFormGetValues<ITechSupportEstimateForm.IForm>;
        setValue: UseFormSetValue<ITechSupportEstimateForm.IForm>;
        onClickSubmit: () => void;
        rows: GridRowsProp;
