...
const VTechSupportEstimateForm: React.FC<
    ITechSupportEstimateForm.IVProps
> = props => {
            ...
            <form autoComplete="off" onSubmit={onClickSubmit}>
                ...
                <div className="btn-section">
                    ...
                    <Button
                        ...
                        type="submit"
                    >
                        {router.pathname === PATH.TECHSUPPORT.ESTIMATE.REGISTER
                            ? "등록"
                            : "수정"}
                    </Button>
                </div>
...
export default VTechSupportEstimateForm;
