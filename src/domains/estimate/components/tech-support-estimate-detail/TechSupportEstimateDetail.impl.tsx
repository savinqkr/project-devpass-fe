...
import VTechSupportEstimateDetail from "./TechSupportEstimateDetail.view";
import { GridColDef } from "@mui/x-data-grid";
import moneyToNumber from "@utils/moneyToNumber";
import numberToMoney from "@utils/numberToMoney";
import { TextareaCell } from "@common/components";

const TechSupportEstimateDetail: React.FC<
    ITechSupportEstimateDetail.IProps
> = props => {
...
export default TechSupportEstimateDetail;
