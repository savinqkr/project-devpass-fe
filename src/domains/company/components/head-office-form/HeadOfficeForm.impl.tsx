...
import VHeadOfficeForm from "./HeadOfficeForm.view";
import { Box, Button, Chip } from "@mui/material";
import { GridColDef, GridRowId } from "@mui/x-data-grid";
import { AttachmentState } from "@enums";
import { Colors } from "@configs/colors";

const HeadOfficeForm: React.FC<IHeadOfficeForm.IProps> = props => {
    const { passbookRows, setPassbookRows, passbookApiRef } = props;
